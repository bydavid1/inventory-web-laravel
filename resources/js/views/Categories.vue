    ...
    <div class="card card-info mt-2">
      ...
      <div class="card-body">
        <ul class="nav nav-tabs justify-content-center" role="tablist">
          <li class="nav-item">
            <a class="nav-link" id="home-tab-center" href="#" aria-controls="home-center" role="tab"
              aria-selected="true">
            Proveedores
            </a>
          </li>
          <li class="nav-item current">
            <a class="nav-link active" id="service-tab-center" href="#" aria-controls="service-center"
              role="tab" aria-selected="false">
            Categorías
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="account-tab-center" href="#" aria-controls="account-center" role="tab"
              aria-selected="false">
            Fabricantes
            </a>
          </li>
            ...
            <form id="createForm" method="POST">
              ...
              <div class="alert bg-rgba-primary alert-dismissible mb-2" role="alert">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <span>
                  La descripcion es opcional, ideal si tiene conectado su propio sitio web para
                  mostrarle al cliente mas informacion.
                  </span>
                </div>
              </div>
          ...
          <div class="modal-body">
            <form id="editform" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <textarea name="udescription" id="udescription" class="form-control"
                    placeholder="Ingrese una descripcion" cols="30" rows="10">
                  </textarea>
                </div>
              </div>
              <button type="submit" class="btn btn-primary btn-block" id="editCategory"
                data-loading-text="Loading..." autocomplete="off"><i class="bx bx-edit"></i>
              Guardar</button>
            </form>
          </div>
        </div>
