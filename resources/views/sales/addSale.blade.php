    ...
    <div class="content-body h-100">
        <form class="h-100" id="createOrderForm">
            ...
            <div class="row h-100">
                ...
                <div class="col-md-4 p-0 h-100 overflow-auto" style="border-left: 1px solid #707070">
                    ...
                    <!-- card-->
                    <div class="card card-outline card-danger h-50">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="decimal" class="form-control" id="additionalPayments"
                                        name="additionalPayments" placeholder="Pago adicional" onkeyup="calculate()">
                                </div>
