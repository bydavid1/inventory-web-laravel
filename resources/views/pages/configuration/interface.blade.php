<div class="customizer customizer-content p-2">
    <h4 class="mb-0"><i class='bx bxs-palette mr-1'></i>Interfaz</h4>
    <small>Configura la interfaz de la aplicacion</small>
    <hr>
    <!-- Theme options starts -->
    <h5 class="mt-1">Tema por defecto</h5>
          ...
          <fieldset>
            <div class="radio">
              <input type="radio" name="layoutOptions" value="false" id="radio-light" class="layout-name" data-layout=""
                checked>
              <label for="radio-light">Claro</label>
            </div>
          </fieldset>
        </div>
        <div class="mx-50">
          <fieldset>
            <div class="radio">
              ...
              <label for="radio-dark">Oscuro</label>
            </div>
          </fieldset>
        </div>
    ...
    <div class="collapse-sidebar d-flex justify-content-between align-items-center">
      <div class="collapse-option-title">
        <h5 class="pt-25">Colapsar menu</h5>
      </div>
    ...
    <div id="customizer-navbar-colors">
      <h5>Cambiar color del la barra superior</h5>
      <ul class="list-inline unstyled-list">
    ...
    <!-- Navbar colors starts -->
    <!-- Navbar Type Starts -->
    <h5>Tipo de barra superior</h5>
    <div class="navbar-type d-flex justify-content-start">
      <div class="hidden-ele mx-50">
        <fieldset>
          <div class="radio">
            <input type="radio" name="navbarType" value="false" id="navbar-hidden">
            <label for="navbar-hidden">Oculto</label>
          </div>
        </fieldset>
      </div>
      <div class="mx-50">
        <fieldset>
          <div class="radio">
            ...
            <label for="navbar-static">Estatico</label>
          </div>
        </fieldset>
      </div>
      <div class="mx-50">
        <fieldset>
          <div class="radio">
            ...
            <label for="navbar-sticky">Fijo</label>
          </div>
        </fieldset>
      </div>
    </div>
    ...
    <!-- Footer Type Starts -->
    <h5>Tipo de footer</h5>
    <div class="footer-type d-flex justify-content-start">
      <div class="mx-50">
        <fieldset>
          <div class="radio">
            <input type="radio" name="footerType" value="false" id="footer-hidden">
            <label for="footer-hidden">Oculto</label>
          </div>
        </fieldset>
      </div>
      <div class="mx-50">
        <fieldset>
          <div class="radio">
            ...
            <label for="footer-static">Estatico</label>
          </div>
        </fieldset>
      </div>
      <div class="mx-50">
