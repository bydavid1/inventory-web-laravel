    ...
    <div class="card mt-2">
      <div class="card-body">
        <ul class="nav nav-tabs justify-content-center" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="service-tab-center" href="#" aria-controls="service-center" role="tab"
              aria-selected="false">
              Categorías
            </a>
          </li>
          <li class="nav-item current">
            <a class="nav-link active" id="account-tab-center" href="#" aria-controls="account-center" role="tab"
              aria-selected="false">
              Fabricantes
            </a>
          </li>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="logo" accept="image/png, image/jpeg, image/jpg"
                    name="imagepath">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <form id="editform" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="form-group col-6">
                  ...
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" disabled id="ulogo" name="ulogo"
            ...
            <div class="modal-footer">
              <button type="submit" id="editManufacturer" class="btn btn-primary btn-block"
                data-loading-text="Loading..." autocomplete="off" disabled>
